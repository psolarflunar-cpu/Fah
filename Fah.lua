...
folder1:AddSwitch("Auto STR TP (Strength) เปิดปิด2รอบ", function(bool)
...
folder1:AddSwitch("Auto Shield (เกราะ)", function(bool)
    _G_AutoShield = bool
        ...
        task.spawn(function()
            while _G_AutoSword do
                pcall(function()
                    ...
                    game:GetService("ReplicatedStorage"):WaitForChild("shared"):WaitForChild("Remotes"):WaitForChi